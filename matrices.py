...
def crear_matriz(filas, columnas, frame, editable=True):
    """Genera una matriz en la interfaz gráfica."""
    matriz = []
...
def obtener_matriz(matriz):
    """Convierte la matriz de Tkinter en una matriz de SymPy."""
    try:
...
def mostrar_resultado(matriz_resultado):
    """Muestra la matriz resultado en la interfaz gráfica."""
...
def calcular_operacion(operacion):
    """Realiza la operación seleccionada en la matriz."""
