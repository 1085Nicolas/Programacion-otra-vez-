...
def iniciar_sesion():
    ...
    def validar_inicio_sesion():
        """
        Valida las credenciales del usuario contra Firebase
        """
...
def mostrar_historial(user_id):
    """
    Muestra el historial del usuario en una ventana.
    """
...
cred = credentials.Certificate("C:\\Users\\basti\\OneDrive\\Documentos\\programacion2024-2\\supercalculadoratilininsano-firebase-adminsdk-fbsvc-0ee2bf35a2.json")
...
def mostrar_historial_calculadora():
    """
    Muestra el historial si hay un usuario logueado, si no, sugiere iniciar sesión
    """
    global current_user_id
...
def clear_all():
    isertar.delete(0, tk.END)  # Limpiar el Entry
    ver.config(text="Valor guardado: ")  # Limpiar la etiqueta
    global num1, num2, op
    num1 = 0
    num2 = 0
    op = ""
